...
int64 nChainStartTime = 1461757810;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Ari 23, 2015, Putin Signs Treaty To Add Crimea To Map.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x67f66dc5173d487c8b0ad1ca71d64e3a78e50533966de6a341b7fe2fb30035a4"));
...
unsigned char pchMessageStart[4] = { 0x69, 0x65, 0x64, 0x61 };
